...
export default function AboutUs() {
  return (
    <div className="w-full min-h-screen pt-20 pb-20 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto bg-white dark:bg-[#2b2b2b] rounded-2xl shadow-xl p-8 md:p-12 transition-colors duration-300">
        <Link to="/" className="inline-flex items-center mb-8 px-4 py-2 btn-back transition-all">
          <i className="fa-solid fa-arrow-left-long pr-2"></i>
          Back to Home
        </Link>

        <h1 className="text-3xl md:text-5xl font-black mb-10 text-center">
